...
function preload() {
     doodle_model = ml5.imageClassifier("DoodleNet");
}



function classify_doodle() {
     doodle_model.classify(canvas, getResults);
}
...
function getResults(e, r) {
     if (e) {
         ...
         // console.log(r);
          ...
          document.getElementById("confidence").innerHTML = "Confidence: "+ floor(r[0].confidence*100)+" %";
     }
}